      ...
      stories: [
        {
          ...
          summary: 'Electron has stated that it will be dropping support JavaScript\'s modern native import/export. The popular <code>import module from \'./module.js\'</code> pattern will be removed from Electron.',
